...
namespace BP2415.Commands.Slash
{
	...
	/// </summary>
	public class MusicSlash : ApplicationCommandsModule
	{
		/// <summary>
		...
		[SlashCommand("pley", "Play music asynchronously")]
		public static async Task PlayAsync(InteractionContext ctx,
			[Option("query", "Search string or Youtube link")] string query)
		{
			...
			node = lava.ConnectedSessions.Values.First();
			connection = node.GetGuildPlayer(ctx.Member!.VoiceState!.Guild!);
